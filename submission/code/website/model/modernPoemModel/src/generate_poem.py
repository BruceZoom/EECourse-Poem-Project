...
class SeqGAN():
    def __init__(self, sess, batch_size):
        ...
        vocab_file = './model/modernPoemModel/models/word2id_5.json'
...
ckpt_file = './model/modernPoemModel/models/ckpt/epoch03_lr0.000005.ckpt'
sess_config = tf.ConfigProto()
os.environ['CUDA_VISIBLE_DEVICES'] = str(config.gpus)

mysess = tf.InteractiveSession(config=sess_config)

batch_size = 1
model = SeqGAN(mysess, batch_size)
